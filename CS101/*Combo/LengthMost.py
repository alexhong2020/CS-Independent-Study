...
def count(phrase):
    ...
    a string that indicates the length that
    has the most words (or all the ones that
    tied, in sorted numeric order and separated
    by dashes) and how many words was the most.
    ...
    return str(max_length) + ":" + "-".join(max_length_words)