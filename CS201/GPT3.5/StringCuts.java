...
public class StringCuts {
    public String[] filter(String[] list, int minLength) {
        Set<String> uniqueStrings = new LinkedHashSet<>(); // Use LinkedHashSet to maintain insertion order
        ...
        // Convert the unique strings to an array
        String[] result = new String[uniqueStrings.size()];
        uniqueStrings.toArray(result);
